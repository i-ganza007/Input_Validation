<template>
    <div class="fixed top-0 left-0 right-0  z-[900] bg-[#800080] h-1  top-0"></div>
    <nav class="flex items-center justify-between px-4 bg-[#EDCD1F] h-32 border-b-20 border-[#1E2D3B] py-10">
        <div class="flex items-center gap-3">
            <svg class="w-10"  preserveAspectRatio="xMidYMid meet" data-bbox="-88.7 -33.025 177.4 181.925" viewBox="-88.7 -33.025 177.4 181.925" height="200" width="200" xmlns="http://www.w3.org/2000/svg" data-type="shape" role="presentation" aria-hidden="true">
                <g>
            ...
            <h2 class="text-2xl text-[#1E2D3B]"><strong>SPHERE</strong> CONSTRUCTIONS</h2>
        </div>

        <div>
            <img src="../assets/hamb.png" alt="hamburger menu" width="32px">
        </div>
    </nav>
</template>
